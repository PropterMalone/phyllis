...
export interface CalendarConfig {
	...
	/**
	 * Calendars consulted by checkBusy() to decide whether the user is busy.
	 ...
	 * that aren't "the user is unavailable" signals. Explicitly setting this
...
export function paths(config: PhyllisConfig) {
	return {
		...
		burnAlert: join(config.home, "state", "burn-alert.json"),
